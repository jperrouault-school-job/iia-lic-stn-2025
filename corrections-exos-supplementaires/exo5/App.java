public class App {
    public static void main(String[] args) {
        /*
            Récupérer la liste des livres, ne prendre que les titres dont le nombre de pages est > 500, concaténer "Titre, de Auteur". Afficher les informations.
        */
        ...
        biblio.getLivres().stream()
            .filter(livre -> livre.getNbPages() > 500)
            .map(livre -> livre.getTitre() + ", de " + livre.getAuteur())
